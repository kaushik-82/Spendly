 ...
 const handleScanComplete = (scannedData) => {
  if (scannedData) {
    ...
    if (scannedData.category) {
      // Find if the scanned category matches an id or name
      ...
      if (matchedCategory) {
        // ✅ Set type correctly first
        setValue("type", matchedCategory.type);
        // ✅ Then set category id
          ...
          >
            ...
            <SelectContent>
              ...
              <CreateAccountDrawer>
                <Button
                    variant="ghost"
                    className="relative flex w-full cursor-default select-none items-center justify-center rounded-sm py-1.5 px-3 text-sm outline-none hover:bg-accent hover:text-accent-foreground"
                >
                    Create Account
                </Button>
